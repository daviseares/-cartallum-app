        ...
        <>
            ...
            <View style={styles.principal}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={{ marginBottom: 20 }}>davi@acodedreams.com.br</Text>
                ...
                <View style={styles.row}>
                    ...
                    <Text>Clayton Vieira Fraga Filho</Text>
                    <Text style={styles.email}>clayton.fraga.ufes@gmail.com</Text>

                    <Text>Geraldo Regis Mauri</Text>
                    <Text style={styles.email}>geraldo.mauri@ufes.com</Text>

                    <Text>Giuliano Prado de Morais Giglio</Text>
                    <Text style={styles.email}>giucontato@gmail.com</Text>
                ...
                <View style={styles.creditos}>
                    <Text style={styles.txtCreditos}>Universidade Federal do Espírito Santo</Text>
